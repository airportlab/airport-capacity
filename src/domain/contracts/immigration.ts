...
export const immigrationContract: ComponentContract = {
  id: "immigration",
  title: "Imigração",
  sheetName: "Imigracao",
  requirements: {
  ...
  subtitle:
    "Fila de imigração. Área pelo guia mínimo — só há valor de contrato na hora-pico internacional.",
  params: pickFields(AREA_PARAM_IDS, {
    areaMedida: {
      defaultValue: 80,
      origem: "Área informada / medida da fila de imigração.",
    },
