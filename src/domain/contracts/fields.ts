...
const TEMPLATES: Record<ComponentParamId, ParamField<ComponentParamId>> = {
  ...
  demandaPicoEmbarqueDomestico: {
    ...
    kind: "attribute",
    label: "DHp (Origem Doméstico)",
    unit: "pax/h",
    defaultValue: 400,
    origem: "Atributo do fluxo de origem doméstico.",
  },
  demandaPicoEmbarqueInternacional: {
    id: "demandaPicoEmbarqueInternacional",
    kind: "attribute",
    label: "DHp (Origem Internacional)",
    unit: "pax/h",
    defaultValue: 400,
    origem: "Atributo do fluxo de origem internacional.",
  },
  demandaPicoDesembarqueDomestico: {
    id: "demandaPicoDesembarqueDomestico",
    kind: "attribute",
    label: "DHp (Destino Doméstico)",
    unit: "pax/h",
    defaultValue: 400,
    origem: "Atributo do fluxo de destino doméstico.",
  },
  demandaPicoDesembarqueInternacional: {
    id: "demandaPicoDesembarqueInternacional",
    kind: "attribute",
    label: "DHp (Destino Internacional)",
    unit: "pax/h",
    defaultValue: 400,
    origem: "Atributo do fluxo de destino internacional.",
  },
